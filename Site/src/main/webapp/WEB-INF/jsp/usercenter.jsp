...
<div class="container-fluid">
    <div id="user">
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="/resources/headimg/${isLogin.headImg}" width="80px" height="200px" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">${isLogin.uName}</h5>
                <p class="card-text">${isLogin.uDesc}</p>
                <a href="/redirect_updateinfo" class="btn btn-primary">修改资料</a>
            </div>
        </div>
    </div>
    <div id="content">
